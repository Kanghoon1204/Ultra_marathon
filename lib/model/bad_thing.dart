...
class BadThing extends SpriteComponent
    with HasGameRef, CollisionCallbacks {
  BadThing() : super(size: Vector2.all(8));
  ...
  Future<void>? onLoad() async {
    fast = await Sprite.load('missile_normal.png');
    normal = await Sprite.load('missile_fast.png');
